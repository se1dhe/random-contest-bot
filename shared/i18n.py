...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "twitch_channel": "Twitch канал",
        "kick_channel": "Kick канал",
        ...
        "twitch_auth_required": "Для участия в конкурсе необходимо авторизоваться через Twitch",
        "twitch_follow_days_required": "Необходимо фолловить Twitch-канал не менее {days} {unit}",
        "twitch_follow_required": "Необходимо фолловить указанный Twitch-канал",
        "kick_auth_required": "Для участия в конкурсе необходимо авторизоваться через Kick",
        "kick_follow_unverified": "Не удалось подтвердить фолловинг Kick-канала. Откройте Kick ещё раз и попробуйте позже.",
        "kick_follow_days_required": "Необходимо фолловить Kick-канал не менее {days} {unit}",
        "kick_follow_required": "Необходимо фолловить указанный Kick-канал",
    ...
    "uk": {
        ...
        "twitch_auth_required": "Для участі в конкурсі необхідно авторизуватися через Twitch",
        "twitch_follow_days_required": "Необхідно фолловити Twitch-канал щонайменше {days} {unit}",
        "twitch_follow_required": "Необхідно фолловити вказаний Twitch-канал",
        "kick_auth_required": "Для участі в конкурсі необхідно авторизуватися через Kick",
        "kick_follow_unverified": "Не вдалося підтвердити фолловинг Kick-каналу. Відкрийте Kick ще раз і спробуйте пізніше.",
        "kick_follow_days_required": "Необхідно фолловити Kick-канал щонайменше {days} {unit}",
        "kick_follow_required": "Необхідно фолловити вказаний Kick-канал",
    ...
    "en": {
        ...
        "twitch_auth_required": "You need to authorize with Twitch to join the contest",
        "twitch_follow_days_required": "You need to follow the Twitch channel for at least {days} {unit}",
        "twitch_follow_required": "You need to follow the specified Twitch channel",
        "kick_auth_required": "You need to authorize with Kick to join the contest",
        "kick_follow_unverified": "Could not confirm the Kick channel follow. Open Kick again and try later.",
        "kick_follow_days_required": "You need to follow the Kick channel for at least {days} {unit}",
        "kick_follow_required": "You need to follow the specified Kick channel",
